...
\newcommand{\schoolInstitution}{%
    Universidade do Argard - UAD
    \par
    Faculdade de Meteorologia
    \par
    Programa de Pós-Graduação
}
\newcommand{\projectType}{Artigo Científico}
...
% Artigo
\newcommand{\projectForeignName}{Canonical Scientific Article template in SpeedLatex} % Nome extrangeiro
