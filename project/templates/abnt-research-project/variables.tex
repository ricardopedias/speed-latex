...
\newcommand{\projectOrienting}{Odin}
\newcommand{\projectCoorientingLabel}{Prof.}%rotulo
\newcommand{\projectCoorienting}{Loki}

% Artigo
\newcommand{\projectForeignName}{Canonical Research Project in SpeedLatex} % Nome extrangeiro
