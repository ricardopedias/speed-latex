...
\hypersetup{
        ...
        pdfcreator={Speed Latex with abnTeX2},
        pdfkeywords={latex}{abntex2}{speed latex},
        colorlinks=true,          % false: boxed links; true: colored links
        linkcolor=link_text,   % color of internal links
        citecolor=cite_text,   % color of links to bibliography
        filecolor=file_text,   % color of file links
        urlcolor=url_text,
        bookmarksdepth=4
}
\makeatother
...
% Personaliza as linhas pontilhadas
\renewcommand{\cftpartleader}{ \color{summary_item}\dotfill}
\renewcommand{\cftchapterleader}{ \color{summary_item}\dotfill}
\renewcommand{\cftsectionleader}{ \color{summary_item}\dotfill}
\renewcommand{\cftsubsectionleader}{ \color{summary_item}\dotfill}
\renewcommand{\cftsubsubsectionleader}{ \color{summary_item}\dotfill}
