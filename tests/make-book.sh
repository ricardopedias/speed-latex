...
# rotina de execução
{
    ...
    ./speedlatex.sh -p test-book --type="book"; # cria um novo projeto latex
    ./speedlatex.sh -c tests/temp/test-book; # compila o projeto
    cp tests/temp/test-book/project.pdf project/book.pdf;
